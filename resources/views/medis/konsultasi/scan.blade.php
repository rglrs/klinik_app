...
@section('title', 'Scan Pasien Konsultasi')
@section('header', 'Antrean Konsultasi Dokter')
...
<div class="max-w-7xl mx-auto space-y-8">
    <div class="bg-white rounded-[2rem] shadow-sm border border-gray-100 p-10 text-center">
        <div class="mb-8">
            <div class="h-20 w-20 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center mx-auto mb-6 shadow-inner">
                <svg class="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg>
            </div>
            <h2 class="text-3xl font-extrabold text-gray-900 tracking-tight">Mulai Konsultasi Pasien</h2>
            <p class="text-gray-500 mt-2 text-lg">Scan barcode ID Card Karyawan untuk check-in konsultasi medis</p>
        </div>

        <form action="{{ route('medis.konsultasi.process') }}" method="POST" class="max-w-xl mx-auto flex flex-col gap-4">
            @csrf
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-6 border-b border-gray-100 flex flex-col md:flex-row justify-between items-center gap-4 bg-gray-50/50">
            <h3 class="text-lg font-bold text-gray-800 w-full md:w-auto">Riwayat Rekam Medis (Konsultasi)</h3>
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-gray-50/50">
                        ...
                        <th class="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider border-b border-gray-100">Waktu Periksa</th>
                        <th class="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider border-b border-gray-100">Dokter Pemeriksa</th>
                    </tr>
                </thead>
                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-sm font-medium">
                            ...
                            <div class="text-xs text-gray-500">
                                {{ \Carbon\Carbon::parse($r->tanggal_periksa)->format('H:i') }} WIB
                            </div>
                        </td>
