...
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-semibold text-gray-800">Laporan Konsultasi Dokter (Rekam Medis)</h2>
    </div>

    <form action="{{ route('admin.laporan.konsultasi') }}" method="GET" class="flex flex-wrap gap-4 mb-6 items-end bg-white p-4 rounded shadow">
        <div>
        ...
        <div class="flex gap-2">
            ...
            <a href="{{ route('admin.laporan.konsultasi.export', request()->all()) }}" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded shadow transition">Export Excel</a>
        </div>
    </form>
        ...
        <table class="w-full whitespace-no-wrap table-auto">
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4">{{ $item->diagnosa }}</td>
                </tr>
                @empty
                <tr>
