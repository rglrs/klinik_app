...
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-semibold text-gray-800">Laporan Permintaan Obat</h2>
    </div>

    <form action="{{ route('admin.laporan.permintaan-obat') }}" method="GET" class="flex flex-wrap gap-4 mb-6 items-end bg-white p-4 rounded shadow">
        <div>
        ...
        <div class="flex gap-2">
            ...
            <a href="{{ route('admin.laporan.permintaan-obat.export', request()->all()) }}" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded shadow transition">Export Excel</a>
        </div>
    </form>
        ...
        <table class="w-full whitespace-no-wrap table-auto">
            <thead>
                <tr class="text-left font-bold text-gray-700 bg-gray-100 border-b">
                    <th class="px-6 py-4">Waktu Permintaan</th>
                    <th class="px-6 py-4">NIK</th>
                    <th class="px-6 py-4">Nama Pasien</th>
                    <th class="px-6 py-4">Tenaga Medis</th>
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-50">
                    <td class="px-6 py-4">{{ $item->waktu_permintaan }}</td>
                    ...
                    <td class="px-6 py-4">{{ $item->penyakit->nama_penyakit }}</td>
                    <td class="px-6 py-4">{{ $item->details->count() }} Jenis Obat</td>
                </tr>
                @empty
                <tr>
